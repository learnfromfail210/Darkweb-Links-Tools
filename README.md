...
This repository organizes publicly available resources, documentation, and tools for learning how dark-web infrastructure works, researching online privacy, and understanding cybersecurity threats.

Focus: Cybersecurity • Privacy • OSINT • Tor • Threat Intelligence • Education

    *Disclaimer: This repository is intended for legal, ethical, and educational use only. Do not use the listed resources or tools to access, facilitate, or participate in illegal activity.*
---
...
- ⬇️ Download: https://www.torproject.org/download/

### Tails

Portable operating system designed around privacy and anonymity.

- 🌐 Website: https://tails.net/

- ⬇️ Download: https://tails.net/install/

### Whonix

Privacy-focused operating system designed to route applications through Tor.

- 🌐 Website: https://www.whonix.org/

- ⬇️ Download: https://www.whonix.org/wiki/Download

### I2P

Privacy-oriented decentralized network.

- 🌐 Website: https://geti2p.net/

- ⬇️ Download: https://geti2p.net/en/download
...
Automated OSINT reconnaissance and information-gathering framework.

- 💻 GitHub: https://github.com/smicallef/spiderfoot

- ⬇️ Releases: https://github.com/smicallef/spiderfoot/releases

### theHarvester

OSINT tool for gathering publicly available information during security assessments.

- 💻 GitHub: https://github.com/laramies/theHarvester

- ⬇️ Releases: https://github.com/laramies/theHarvester/releases
...
- ⬇️ Download: https://www.maltego.com/downloads/
...
Download software only from official websites or official GitHub repositories.

This repository focuses on legitimate cybersecurity research, privacy education, OSINT, and defensive security.
